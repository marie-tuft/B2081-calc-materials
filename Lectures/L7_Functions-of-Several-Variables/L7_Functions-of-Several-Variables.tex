...
\vspace{12pt}
An example of a function which does not have equal mixed partials can be found \href{https://www.math.tamu.edu/~tom.vogel/gallery/node18.html}{\beamergotobutton{HERE}}
\end{frame}
